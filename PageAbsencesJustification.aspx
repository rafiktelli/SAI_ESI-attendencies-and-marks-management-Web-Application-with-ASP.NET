<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PageAbsencesJustification.aspx.vb" Inherits="My1stWebApplication.PageAbsencesJustification" %>
...
<div id="dialogbox">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <asp:HyperLink class="navbar-brand brand-logo" id="HyperLink1" runat="server" NavigateUrl="~/PageAbsencesJustification.aspx">
          <img src="Content/images/SAIESI.svg" alt="logo" />
        </asp:HyperLink>
        <asp:HyperLink class="navbar-brand brand-logo-mini" id="lnk1" runat="server" NavigateUrl="~/PageAbsencesJustification.aspx">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  ...
                  <div>
                    <small class="designation text-muted">Personel</small>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic1">
                  ...
                  <asp:DropDownList AppendDataBoundItems="true" CssClass="btn btn-block btn-outline-primary" Width="100%" ID="DDPrm" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource4" DataTextField="Promo" DataValueField="Promo">
                      <asp:ListItem  Value=""  Text=" - - Choisissez une promo - -"></asp:ListItem>
                </asp:DropDownList>  
                  <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:SaisieNotesConnectionString %>" SelectCommand="SELECT DISTINCT Promo FROM INSCRITS ORDER BY Promo"></asp:SqlDataSource>
 ...
 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SaisieNotesConnectionString %>" SelectCommand="SELECT DISTINCT Gr FROM INSCRITS WHERE (Promo =@Promocode) ORDER BY Gr ">
        <SelectParameters>
            <asp:SessionParameter Name="Promocode" SessionField="promocode"/>
        </SelectParameters>
            </asp:SqlDataSource>
          ...
          <div class="content-wrapper">
             ...
             <div class="col-12" style="height:15%;" >
              <span class="d-block d-md-flex align-items-center" style="height:70px;" >
               <span class="badge badge-inverse-primary" style="background-color:#F2F8F9;width:40%;height:90%;vertical-align:text-bottom;font-size:17px;text-align:center;transform:translate(5%,0%);">Promotion : <asp:Label runat="server" ID="LabelPrm" Text="ND"></asp:Label></span>
               ...
               <span class="badge badge-inverse-primary" style="background-color:#F2F8F9;width:40%;height:90%;vertical-align:bottom; font-size:17px; transform:translate(5%,0%);">Groupe : <asp:Label runat="server" ID="LabelGrp" Text="ND"></asp:Label></span>
                  ...
                  <h2 style="margin-top:10%;margin-right:10%;"><asp:Label runat="server" ID="LabelMsg" Text=""></asp:Label></h2>
                  <div id="divEGV" runat="server" class="scroll-container" style="padding: 2px;margin-top:-7%; display: inline-block; ">
                 
             <h3 style="margin-left:10%;"><asp:Label runat="server" ID="LabelMsg2" Text=""></asp:Label></h3>
              <asp:GridView  ID="EtudiantGrid" runat="server"   AutoGenerateColumns="False" width="80%" Height="390px" CssClass="scroll-container table-responsive  table table-hover text-center table-bordered "  BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="0px" CellPadding="0" GridLines="Vertical" style="font-family: Calibri;font-size:14px;margin:auto;" DataSourceID="SqlDataSource2">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="NomEtud" HeaderText="Noms" ItemStyle-HorizontalAlign="NotSet" ControlStyle-Font-Size="Medium" ItemStyle-Height="30px" ItemStyle-Width="300px" SortExpression="NomEtud" >
                        <ControlStyle Font-Size="Medium"></ControlStyle>

                        <ItemStyle Height="30px" Width="300px"></ItemStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="Prenoms" HeaderText="Prenoms"  ItemStyle-HorizontalAlign="NotSet" ControlStyle-Font-Size="Medium" ItemStyle-Height="30px" ItemStyle-Width="300px" SortExpression="Prenoms">                   
                    
                        <ControlStyle Font-Size="Medium"></ControlStyle>

                        <ItemStyle Height="30px" Width="300px"></ItemStyle>
                    </asp:BoundField>
             <asp:TemplateField HeaderText="Abs. Justifié">
                        <ItemTemplate>
                            <asp:CheckBox Width="200px" ControlStyle-Font-Size="Medium" CssClass=" form-check form-check-input" ID="JustfCheckBox" runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SaisieNotesConnectionString %>" SelectCommand="SELECT DISTINCT absence.Matricule, etudiant.NomEtud, etudiant.Prenoms FROM ABSENCES AS absence INNER JOIN ETUDIANTS AS etudiant ON absence.Matricule = etudiant.Matricule INNER JOIN INSCRITS AS inscrit ON absence.Matricule = inscrit.Matricule AND absence.Matricule = inscrit.Matricule WHERE (inscrit.Gr = @Gr) AND (absence.Jour = @dT) AND (inscrit.Promo = @promocode)  ORDER BY etudiant.NomEtud" >
    
               <SelectParameters>
                  <asp:SessionParameter Name="Gr" SessionField="Gr" Type="String" />
                  <asp:SessionParameter Name="promocode" SessionField="promocode" Type="String" />
                  <asp:SessionParameter Name="dT" SessionField="dT" Type="datetime" />
