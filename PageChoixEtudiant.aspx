<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PageChoixEtudiant.aspx.vb" Inherits="My1stWebApplication.PageChoixEtudiant" %>
...
#dialogbox > div > #dialogboxfoot{ background: #F0F0F0  ; padding:10px; text-align:right; }
    ...
    section .screen:nth-child(1) {
        background-image:url(./image/imf1.jpg);
  ...
  <div>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        ...
        <asp:HyperLink class="navbar-brand brand-logo-mini" id="HyperLink2" runat="server" NavigateUrl="~/PageChoixEtudiant.aspx">
        ...
        <div class="screen">
            ...
            <div class="cardo">
                <div id="imgbx1" class="imgbox">
                    <asp:HyperLink id="lnk1" runat="server" NavigateUrl="~/PageNotesAffichage.aspx">
                    <div class="bouton b1" ><div class="sousb"><h3>Consultation des</h3> <h1>Notes</h1></div></div>
                    </asp:HyperLink>
                </div>
            </div>
        </div>
        <div class="screen">
            <div class="cardo">
                <div id="imgbx2" class="imgbox">
                    <asp:HyperLink ID="lnk2" runat="server" NavigateUrl="~/PageAbsenceAffichage.aspx">
                    <div class="bouton b2"  ><div class="sousb"><h3>Consultation des</h3> <h1>Abscences</h1></div></div>
                    </asp:HyperLink>
                </div>
            </div>
        </div>
